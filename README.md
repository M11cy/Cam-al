...
- снижает нагрузку на компьютер: нейросети запускаются не на каждом кадре, а раз в несколько секунд.
...
- `analysis_interval_seconds` - как часто запускать анализ кадра нейросетями, по умолчанию `3`;
